...
export const Timeline = ({ data }) => {
  ...
  return (
    <div
      ...
      ref={containerRef}
    >
      {/* ✅ Background image same as Tech Stack */}
      <div
        className="absolute inset-0 bg-cover bg-center opacity-40"
        style={{
          backgroundImage: "url('/assets/images/tech-bg.webp')", // replace with your actual path
            ...
            >
              ...
              <div className="relative w-full pl-20 pr-4 md:pl-4">
                ...
                {item.contents.map((content, index) => (
                  <p
                    className="mb-3 font-normal text-neutral-200 leading-relaxed"
                    key={index}
                  >
                    {content}
                  </p>
